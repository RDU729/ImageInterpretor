...
public class ErrorResponse {
    ...
    public ErrorResponse(ErrorCodes errorCode, HttpStatus status, LocalDateTime timeStamp, String message) {
        this();
    ...
    public ErrorResponse(ErrorCodes errorCode, HttpStatus status, String message) {
        this();
        this.errorCode = errorCode;
        this.status = status;
        this.message = message;
